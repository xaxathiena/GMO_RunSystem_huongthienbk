...
function builAll() {
		...
		document.write("<table id = 'tableCalendar'>");
			document.write("<tr>");
				document.write("<td><img src = 'img/arrow-left-big.png' onclick = \"" + "changeTimeIcon('leftBig')\"" + " ></td>");
				document.write("<td><img src = 'img/arrow-left-small.png' onclick = \"" + "changeTimeIcon('leftSmall')\"" + " ></td> ");
				buildMonth();
				buildYear();
				document.write("<td><img src = 'img/arrow-right-small.png' onclick = \"" + "changeTimeIcon('rightSmall')\"" + "></td>");
				document.write("<td><img src = 'img/arrow-right-big.png' onclick = \"" + "changeTimeIcon('rightBig')\"" + "></td>");
			document.write("</tr>");
					buildDay();
